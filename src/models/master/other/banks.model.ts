  ...
  BankMaster.init(
    {
      ...
      bank_branch: { allowNull: false, type: DataTypes.STRING },
      account_type: { allowNull: false, type: DataTypes.STRING },
      account_no: { allowNull: false, type: DataTypes.STRING },
      customer_id: { allowNull: false, type: DataTypes.STRING },
      ifsc_code: { allowNull: false, type: DataTypes.STRING },
      netbanking_username: { allowNull: false, type: DataTypes.STRING },
